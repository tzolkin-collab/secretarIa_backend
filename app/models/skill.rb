...
class Skill
  CATALOG = [
    ...
    { id: "drive_upload",    name: "Salvar no Drive",      category: "media", always_on: false, description: "Salva no Google Drive a mídia enviada com legenda do tipo \"salva no drive\". Requer o conector Google conectado nesta instância." },
    { id: "gmail_digest",    name: "Digest de e-mail",     category: "email", always_on: false, description: "Resumo diário às 08:00 dos e-mails da caixa, classificado por IA (responder/informativo/marketing). Requer o conector Google conectado." },
  ].freeze
